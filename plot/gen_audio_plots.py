...
def main():
    plot_models = {
        'Vision (fixed)': ['low_policy', 'low_policy_audio'],
        'Vision + Language (fixed)': ['subgoal_low_policy', 'subgoal_low_policy_simulator_audio'],
        'Vision (proc gen)': ['low_policy_2', 'low_policy_audio_2'],
        'Vision + Language (proc gen)': ['subgoal_low_policy_simulator_2', 'subgoal_low_policy_simulator_audio_2'],        
    }
    
    plot_names = ['Vision (fixed)', 'Vision + Language (fixed)', 'Vision (proc gen)', 'Vision + Language (proc gen)']
    ...
    for experiment in FINAL_EXPERIMENTS:
        ...
        save_path = os.path.join('/vision/u/emilyjin/marple_long/final_plots/audio')#, experiment_name)
