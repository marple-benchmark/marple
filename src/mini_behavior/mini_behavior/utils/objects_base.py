import os
from marple_mini_behavior.mini_behavior.rendering import *
from marple_mini_behavior.bddl import DEFAULT_STATES, STATE_FUNC_MAPPING, DEFAULT_ACTIONS, OBJECT_TO_IDX, IDX_TO_OBJECT, OBJECTS, ABILITIES
...
class WorldObj:
    ...
    def __init__(self,
        ...
        self.contains = None
        self.inside_of = None
        self.in_room = None  # in which room
        self.on_fur = None  # on which fur
        self.id = None  # absolute id in instances
...
class FurnitureObj(WorldObj):
    ...
    def update_pos(self, pos):
        ...
        for pos in self.all_pos:
            ...
            for d in dirs:
                self.surround_pos.append((pos[0] + d[0], pos[1] + d[1]))
